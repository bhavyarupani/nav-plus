...
class SettingsRepository @Inject constructor(
    ...
    companion object {
        ...
        private val SHOW_WIND_FLOW           = booleanPreferencesKey("real_world_wind_flow")
        private val SHOW_FOG_DEPTH           = booleanPreferencesKey("real_world_fog_depth")
        private val SHOW_STORM_CELL          = booleanPreferencesKey("real_world_storm_cell")
        private val SHOW_AMBIENT_ROUTE_PULSE = booleanPreferencesKey("real_world_route_pulse")
        private val SHOW_EMERGENCY_AWARENESS = booleanPreferencesKey("real_world_emergency_awareness")
        private val SHOW_ROAD_SURFACE        = booleanPreferencesKey("real_world_road_surface")
        private val SHOW_ARRIVAL_MOOD        = booleanPreferencesKey("real_world_arrival_mood")
        private val SHOW_REAL_WEATHER_AHEAD  = booleanPreferencesKey("real_world_weather_ahead")
        private val SHOW_MOON_NIGHT_SKY      = booleanPreferencesKey("real_world_moon_night_sky")
        private val SHOW_HAZARD_SCENE        = booleanPreferencesKey("real_world_hazard_scene")
        // Voice
    ...
    val settings: Flow<UserSettings> = dataStore.data.map { p ->
        UserSettings(
            ...
            showWindFlow                = p[SHOW_WIND_FLOW] ?: true,
            showFogDepthLayer           = p[SHOW_FOG_DEPTH] ?: true,
            showStormCellEncounter      = p[SHOW_STORM_CELL] ?: true,
            showAmbientRoutePulse       = p[SHOW_AMBIENT_ROUTE_PULSE] ?: true,
            showEmergencyVehicleAwareness = p[SHOW_EMERGENCY_AWARENESS] ?: true,
            showRoadSurfaceFeel         = p[SHOW_ROAD_SURFACE] ?: true,
            showDestinationArrivalMood  = p[SHOW_ARRIVAL_MOOD] ?: true,
            showRealWeatherAhead        = p[SHOW_REAL_WEATHER_AHEAD] ?: true,
            showMoonNightSky            = p[SHOW_MOON_NIGHT_SKY] ?: true,
            showVisibleHazardScene      = p[SHOW_HAZARD_SCENE] ?: true,
    ...
    suspend fun setShowWindFlow(v: Boolean)                  { dataStore.edit { it[SHOW_WIND_FLOW] = v } }
    suspend fun setShowFogDepthLayer(v: Boolean)             { dataStore.edit { it[SHOW_FOG_DEPTH] = v } }
    suspend fun setShowStormCellEncounter(v: Boolean)        { dataStore.edit { it[SHOW_STORM_CELL] = v } }
    suspend fun setShowAmbientRoutePulse(v: Boolean)         { dataStore.edit { it[SHOW_AMBIENT_ROUTE_PULSE] = v } }
    suspend fun setShowEmergencyVehicleAwareness(v: Boolean) { dataStore.edit { it[SHOW_EMERGENCY_AWARENESS] = v } }
    suspend fun setShowRoadSurfaceFeel(v: Boolean)           { dataStore.edit { it[SHOW_ROAD_SURFACE] = v } }
    suspend fun setShowDestinationArrivalMood(v: Boolean)    { dataStore.edit { it[SHOW_ARRIVAL_MOOD] = v } }
    suspend fun setShowRealWeatherAhead(v: Boolean)          { dataStore.edit { it[SHOW_REAL_WEATHER_AHEAD] = v } }
    suspend fun setShowMoonNightSky(v: Boolean)              { dataStore.edit { it[SHOW_MOON_NIGHT_SKY] = v } }
    suspend fun setShowVisibleHazardScene(v: Boolean)        { dataStore.edit { it[SHOW_HAZARD_SCENE] = v } }
